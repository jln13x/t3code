    ...
    <SettingsPageContainer>
      <SettingsSection title="Beta features">
        <SettingsRow
          title="Sidebar v2"
          description={
            sidebarV2ForcedByPersonalFlag
              ? "Enabled because Native macOS sidebar is off in Feature Flags. Turn that flag back on to make this Beta switch authoritative again."
