...
describe("ComposerPrimaryActions", () => {
  ...
  it("only renders stop while running when active-turn delivery actions are hidden", () => {
  ...
  it("renders explicit queue and steer actions alongside stop while running", () => {
