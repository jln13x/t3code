...
import Migration0041 from "./Migrations/041_ProjectionThreadTurnQueue.ts";
import Migration0044 from "./Migrations/044_EnsureProjectionThreadTurnQueue.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionThreadTurnQueue", Migration0041],
  [44, "EnsureProjectionThreadTurnQueue", Migration0044],
] as const;
